...
from integration_tests.files import require_empty_dir, make_empty_file, assert_dir_empty, assert_dir_contains
from trashcli.empty import main as empty, EmptyCmd
